...
Route::group([
    ...
    Route::get('/payment/{gateway}/pay', 'GatewayController@pay')->name('pay')->middleware('locale');
    Route::match(['get', 'post'],'/pay/{gateway}/complete', 'GatewayController@makePayment')->name('complete');
